...
test.describe(
    ...
    () => {
        ...
        // ====================================================================
        test.beforeEach(async ({ page, INPUT }) => {
        ...
        // ====================================================================
        test(
            "@CRITICAL Should reject invalid file formats and show validation",
            async ({ page }) => {
        ...
        // ====================================================================
        test(
            "@CRITICAL Should upload valid MP3 file and pass validation",
            async ({ page }) => {
